...
import type { ProjectListOrigin } from '@/features/project/lib/project-search'
...
export function ProjectCard({ project, origin }: { project: Project; origin?: ProjectListOrigin }) {
  const progress =
