...
[文档索引](../README.md) · [前端开发指南](../development/frontend.md) · [工作台 UI 参考图](assets/workspace-ui-reference.png)

本规范集中维护在 `docs/design/`，文档参考素材位于 `assets/`。运行时样式入口为 [`apps/frontend/src/styles/globals.css`](../../apps/frontend/src/styles/globals.css)。
